...
export default function Profile() {
  ...
  const handleSubmit = async () => {
    ...
    setSuccess("");
    try {
      await updateUser(id, { name: form.name, phone: form.phone, email: form.email, avatar: form.avatar });
            ...
            <div className="mb-8">
              ...
              <div className="flex items-center gap-6">
                <div className="w-20 h-20 rounded-xl border-2 border-gray-200 overflow-hidden bg-gray-100 flex items-center justify-center shrink-0">
                  {form.avatar ? (
                    <img src={form.avatar} alt="avatar" className="w-full h-full object-cover" onError={(e) => { e.currentTarget.src = ""; }} />
                  ) : (
