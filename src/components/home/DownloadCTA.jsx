...
const STORE_BUTTONS = [
  { label: "Play Store", icon: faGooglePlay, className: "bg-white text-indigo-700 hover:bg-emerald-50" },
  { label: "App Store", icon: faApple, className: "border border-white/20 text-white hover:bg-white/10" },
];

export default function DownloadCTA() {
  return (
    <section className="px-4 py-12 sm:px-6 sm:py-16 lg:px-10">
      <div className="mx-auto grid max-w-7xl items-center gap-10 overflow-hidden rounded-[2.5rem] bg-slate-950 px-6 py-12 text-white sm:px-10 lg:grid-cols-2 lg:px-14">
        ...
        <div className="text-center lg:text-left">
          <p className="text-xs font-black uppercase tracking-[0.25em] text-emerald-200">Mobile ready</p>
          <h2 className="mt-4 text-3xl leading-tight font-black sm:text-5xl">Download The App</h2>
          <p className="mx-auto mt-5 max-w-lg text-base leading-8 text-slate-300 lg:mx-0">Ready to experience the future of payments? Download e-wallet now and enjoy a world of convenience at your fingertips.</p>
