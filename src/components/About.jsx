  ...
  return (
    <section className="mx-auto grid max-w-7xl grid-cols-1 gap-12 px-6 py-16 lg:grid-cols-2 lg:px-10 lg:py-24">
      ...
      <div className="z-10 flex flex-col justify-center py-2 lg:pr-10">
        ...
        <button className="mt-8 w-fit rounded-lg bg-blue-600 px-10 py-3 text-lg font-semibold text-white shadow-lg transition-all hover:bg-blue-700 active:scale-95">
          Get Started
        </button>
      </div>
