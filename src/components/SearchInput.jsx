...
export default function SearchInput({
  ...
  return (
    <div role="search" className={`relative w-full sm:max-w-xs ${className}`}>
      <input
        type="search"
      ...
      <FontAwesomeIcon
        ...
        className={`pointer-events-none absolute top-1/2 right-4 -translate-y-1/2 transition-colors ${
          disabled ? "text-base-content/50" : "text-base-content/50"
        }`}
        aria-hidden="true"
      />
    </div>
